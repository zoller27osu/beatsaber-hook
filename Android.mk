...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -DVERSION='"0.3.9"' -isystem 'extern/libil2cpp/il2cpp/libil2cpp' -D'UNITY_2019' -Wall -Wextra -Werror -Wno-unused-function -Wno-inaccessible-base -DID='"beatsaber-hook"' -I'./shared' -isystem 'extern' -isystem 'extern/codegen/include'
