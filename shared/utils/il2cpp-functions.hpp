...
class il2cpp_functions {
  public:
    // note: "inline" variables are just definitions as well as declarations, so they don't have to be defined in the .cpp
    // These methods autogenerated by Sc2ad:
    #ifdef UNITY_2019
    inline static int (*init)(const char* domain_name);
    inline static int (*init_utf16)(const Il2CppChar * domain_name);
    #else
    ...
    #ifdef UNITY_2019
    inline static void (*class_for_each)(void(*klassReportFunc)(Il2CppClass* klass, void* userData), void* userData);
    #endif
    ...
    #ifdef UNITY_2019
    inline static void (*type_get_name_chunked)(const Il2CppType * type, void(*chunkReportFunc)(void* data, void* userData), void* userData);
    #endif
    ...
    #ifdef UNITY_2019
    inline static uint32_t (*class_get_data_size)(const Il2CppClass * klass);
    inline static void* (*class_get_static_field_data)(const Il2CppClass * klass);
    #endif
    ...
    #ifdef UNITY_2019
    inline static void (*raise_exception)(Il2CppException*);
    #endif
    ...
    #ifdef UNITY_2019
    inline static bool (*field_is_literal)(FieldInfo * field);
    #endif
    ...
    #ifdef UNITY_2019
    inline static int64_t (*gc_get_max_time_slice_ns)();
    inline static void (*gc_set_max_time_slice_ns)(int64_t maxTimeSlice);
    inline static bool (*gc_is_incremental)();
    #endif
    ...
    #ifdef UNITY_2019
    inline static bool (*gc_has_strict_wbarriers)();
    inline static void (*gc_set_external_allocation_tracker)(void(*func)(void*, size_t, int));
    inline static void (*gc_set_external_wbarrier_tracker)(void(*func)(void**));
    inline static void (*gc_foreach_heap)(void(*func)(void* data, void* userData), void* userData);
    inline static void (*stop_gc_world)();
    inline static void (*start_gc_world)();
    #endif
    ...
    #ifdef UNITY_2019
    inline static void (*gchandle_foreach_get_target)(void(*func)(void* data, void* userData), void* userData);
    inline static uint32_t (*object_header_size)();
    inline static uint32_t (*array_object_header_size)();
    inline static uint32_t (*offset_of_array_length_in_array_object_header)();
    inline static uint32_t (*offset_of_array_bounds_in_array_object_header)();
    inline static uint32_t (*allocation_granularity)();
    #endif
    ...
    #ifdef UNITY_2019
    inline static void (*override_stack_backtrace)(Il2CppBacktraceFunc stackBacktraceFunc);
    #endif
    ...
    #ifdef UNITY_2019
    inline static void (*register_debugger_agent_transport)(Il2CppDebuggerTransport * debuggerTransport);
    inline static bool (*debug_get_method_info)(const MethodInfo*, Il2CppMethodDebugInfo * methodDebugInfo);
    #endif
    ...
    #ifdef UNITY_2019
    inline static void (*class_set_userdata)(Il2CppClass * klass, void* userdata);
    inline static int (*class_get_userdata_offset)();
    #endif
    ...
    inline static Il2CppClass* (*Class_FromIl2CppType)(Il2CppType* typ);
    ...
    inline static void CheckS_GlobalMetadata() {
        if (!s_GlobalMetadataHeader) {
            ...
            Logger::getLogger()->log_debug("sanity: %X (should be 0xFAB11BAF)", s_GlobalMetadataHeader->sanity);
            Logger::getLogger()->log_debug("version: %i", s_GlobalMetadataHeader->version);
            assert(s_GlobalMetadataHeader->sanity == 0xFAB11BAF);
            Logger::getLogger()->log_debug("typeDefinitionsOffset: %i", s_GlobalMetadataHeader->typeDefinitionsOffset);
            Logger::getLogger()->log_debug("exportedTypeDefinitionsOffset: %i", s_GlobalMetadataHeader->exportedTypeDefinitionsOffset);
            Logger::getLogger()->log_debug("nestedTypesOffset: %i", s_GlobalMetadataHeader->nestedTypesOffset);
