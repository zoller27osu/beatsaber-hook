...
void il2cpp_functions::Init() {
    ...
    SEARCH_HOOK(Class, Init,  // 0xA6D1B8 in 1.7
    ...
    if (!hookAddr) {
        log(ERROR, "Failed to find Class::Init. Will use pre 1.7 sigscans from now on.");
        v1_7 = false;
        allSigScanSuccess = backup;
        SEARCH_HOOK(Class, Init,  // 0x846A68 in 1.5
    ...
    if (v1_7) {
        ...
        SEARCH_HOOK(MetadataCache, Register,  // 0xA78B38 in 1.7.0b?
            "ff ? ? d1 ? ? ? a9 ? ? ? a9 ? ? ? a9 ? ? ? 91 ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? f9 ? ? ? f9 ? ? ? f9 ? ? 40 b9 "
            "? 03 ? aa ? 03 ? aa ? ? ? 71 ? ? ? 54 ? 03 1f aa");
    } else {
        SEARCH_HOOK(MetadataCache, Register,  // 0x84DE9C in 1.5
    ...
    if (v1_7) {
        SEARCH_HOOK(MetadataCache, GetTypeInfoFromTypeDefinitionIndex,  // 0xA75958 in 1.7.0b
            "? ? ba a9 ? ? 01 a9 ? ? 02 a9 ? ? 03 a9 ? ? 04 a9 ? ? 05 a9 ? 43 01 91 ? ? 00 31 ? ? ? 54");
    } else {
        SEARCH_HOOK(MetadataCache, GetTypeInfoFromTypeDefinitionIndex,  // 0x84FBA4 in 1.5, 0x8C85E8 in 1.6.3
            "fc 6f ba a9 fa 67 01 a9 f8 5f 02 a9 f6 57 03 a9 f4 4f 04 a9 fd 7b 05 a9 fd 43 01 91 f4 03 00 2a 9f 06 00 31 ? ? ? 54 "
            "? ? ? ? ? ? ? f9 ? ? ? f8 ? ? ? b5 ? ? ? ? ? ? ? f9");
    }

    if (v1_7) {
        // (longlong *)(DAT_0244c820 + (longlong)*(int *)(DAT_0244c828 + 0xa0) + (longlong)iParm2 * 0x5c);
        il2cpp_functions::MetadataCache_GetTypeDefinitionFromIndex = il2cpp_functions::GetTypeDefinitionFromIndex;
    } else {
        SEARCH_HOOK(MetadataCache, GetTypeDefinitionFromIndex,  // 0x84FFBC in 1.5, 0x8C8A00 in 1.6.3
            "1f 04 00 31 ? ? ? 54 ? ? ? ? ? ? ? f9 ? ? ? ? ? ? ? f9 ? ? ? b9 28 01 08 8b ? ? ? 52 00 20 29 9b c0 03 5f d6");
    }

    if (v1_7) {
        // *(int *)(DAT_0244c820 + (longlong)*(int *)(DAT_0244c828 + 0x100) + (longlong)iVar1* 4)
        ...
        SEARCH_HOOK(MetadataCache, GetExportedTypeFromIndex,  // 0x84FFF0 in 1.5, 0x8C8A34 in 1.6.3
    ...
    SEARCH_HOOK(MetadataCache, GetGenericContainerFromIndex,  // 0x850018 in 1.5, 0x8C8A5C in 1.6.3, 0xA6EAA4 in 1.7.0b
    ...
    if (v1_7) {
        ...
        SEARCH_HOOK(MetadataCache, GetNestedTypeFromIndex,  // 0x8500BC in 1.5, 0x8C8B00 in 1.6.3
    ...
    if (v1_7) {
        SEARCH_HOOK(_Type, GetName_,  // 0xA7B634 in 1.7.0b
        ...
        SEARCH_HOOK(_Type, GetName_,  // 0x8735DC in 1.5, 0x8EC3B0 in 1.6.3
    ...
    if (v1_7) {
        SEARCH_HOOK(GenericClass, GetClass,  // 0xA6E4EC in 1.7.0b
            "? 0f 1c f8 ? ? 01 a9 ? ? 02 a9 ? ? 03 a9 ? c3 00 91 ? 03 00 aa ? ? ? ? 00 ? ? 91 ? ? ? ? ? ? 40 b9");
    } else {
        SEARCH_HOOK(GenericClass, GetClass,  // 0x88DF64 in 1.5, 0x906E78 in 1.6.3
