...
namespace UnityEngine_Transform {
    ...
    static void Init() {
        if (!__cached) {
            ...
            get_position_Injected_out_Vector3 = il2cpp_functions::class_get_method_from_name(klass, "get_position_Injected", 2);
            set_position_Injected = il2cpp_functions::class_get_method_from_name(klass, "set_position_Injected", 1);
            get_localPosition_Injected_out_Vector3 = il2cpp_functions::class_get_method_from_name(klass, "get_localPosition_Injected", 2);
            set_localPosition_Injected = il2cpp_functions::class_get_method_from_name(klass, "set_localPosition_Injected", 1);
            get_rotation_Injected_out_Quaternion = il2cpp_functions::class_get_method_from_name(klass, "get_rotation_Injected", 2);
            set_rotation_Injected = il2cpp_functions::class_get_method_from_name(klass, "set_rotation_Injected", 1);
            get_localRotation_Injected_out_Quaternion = il2cpp_functions::class_get_method_from_name(klass, "get_localRotation_Injected", 2);
            set_localRotation_Injected = il2cpp_functions::class_get_method_from_name(klass, "set_localRotation_Injected", 1);
            get_localScale_Injected_out_Vector3 = il2cpp_functions::class_get_method_from_name(klass, "get_localScale_Injected", 2);
            set_localScale_Injected = il2cpp_functions::class_get_method_from_name(klass, "set_localScale_Injected", 1);
            get_worldToLocalMatrix_Injected_out_Matrix4x4 = il2cpp_functions::class_get_method_from_name(klass, "get_worldToLocalMatrix_Injected", 2);
            get_localToWorldMatrix_Injected_out_Matrix4x4 = il2cpp_functions::class_get_method_from_name(klass, "get_localToWorldMatrix_Injected", 2);
            ...
            TransformDirection_Injected_Vector3_out_Vector3 = il2cpp_functions::class_get_method_from_name(klass, "TransformDirection_Injected", 3);
            InverseTransformDirection_Injected_Vector3_out_Vector3 = il2cpp_functions::class_get_method_from_name(klass, "InverseTransformDirection_Injected", 3);
            TransformVector_Injected_Vector3_out_Vector3 = il2cpp_functions::class_get_method_from_name(klass, "TransformVector_Injected", 3);
            InverseTransformVector_Injected_Vector3_out_Vector3 = il2cpp_functions::class_get_method_from_name(klass, "InverseTransformVector_Injected", 3);
            TransformPoint_Injected_Vector3_out_Vector3 = il2cpp_functions::class_get_method_from_name(klass, "TransformPoint_Injected", 3);
            InverseTransformPoint_Injected_Vector3_out_Vector3 = il2cpp_functions::class_get_method_from_name(klass, "InverseTransformPoint_Injected", 3);
            get_lossyScale_Injected_out_Vector3 = il2cpp_functions::class_get_method_from_name(klass, "get_lossyScale_Injected", 2);
            __cached = true;
        }
    }
}
