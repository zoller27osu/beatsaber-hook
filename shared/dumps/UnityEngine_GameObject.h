...
namespace UnityEngine_GameObject {
    ...
    static const MethodInfo* GetComponent;
    ...
    static const MethodInfo* GetComponentInChildren;
    static const MethodInfo* GetComponentInChildren_bool;
    ...
    static const MethodInfo* AddComponent;
    ...
    static void Init() {
        ...
        GetComponent = il2cpp_functions::class_get_method_from_name(klass, "GetComponent", 0);
        ...
        GetComponentInChildren = il2cpp_functions::class_get_method_from_name(klass, "GetComponentInChildren", 0);
        GetComponentInChildren_bool = il2cpp_functions::class_get_method_from_name(klass, "GetComponentInChildren", 1);
        ...
        AddComponent = il2cpp_functions::class_get_method_from_name(klass, "AddComponent", 0);
