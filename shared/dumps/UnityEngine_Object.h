...
namespace UnityEngine_Object {
    ...
    static const MethodInfo* Instantiate_T;
    static const MethodInfo* Instantiate_T_Vector3_Quaternion;
    static const MethodInfo* Instantiate_T_Vector3_Quaternion_Transform;
    static const MethodInfo* Instantiate_T_Transform;
    static const MethodInfo* Instantiate_T_Transform_bool;
    ...
    static const MethodInfo* FindObjectOfType;
    ...
    static void Init() {
        ...
        Instantiate_T = il2cpp_functions::class_get_method_from_name(klass, "Instantiate", 1);
        Instantiate_T_Vector3_Quaternion = il2cpp_functions::class_get_method_from_name(klass, "Instantiate", 3);
        Instantiate_T_Vector3_Quaternion_Transform = il2cpp_functions::class_get_method_from_name(klass, "Instantiate", 4);
        Instantiate_T_Transform = il2cpp_functions::class_get_method_from_name(klass, "Instantiate", 2);
        Instantiate_T_Transform_bool = il2cpp_functions::class_get_method_from_name(klass, "Instantiate", 3);
        ...
        FindObjectOfType = il2cpp_functions::class_get_method_from_name(klass, "FindObjectOfType", 0);
